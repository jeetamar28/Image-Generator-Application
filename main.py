...
root = tk.Tk()
root.title("Image Generator Application")
...
def display_image(category):
    ...
    url = f"https://api.unsplash.com/photos/random?query={category}&orientation=landscape&client_id=tP6TzyVywwW2I97-V7bYCvN_NO9rvvPZjjJcq1cx97s"
